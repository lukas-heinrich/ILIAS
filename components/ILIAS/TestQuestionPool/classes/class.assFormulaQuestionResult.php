    ...
    */
    ...
    public function fromNormalized(Transformations $tt): Transformation
    {
        return $tt->custom()->transformation(function (array $normalized) use ($tt): self {
            $clone = clone $this;
            $clone->available_units = array_map(fn(array $unit) => $tt->denormalize($unit, new Unit()), $normalized['available_units']);
            ...
            $clone->unit = $tt->denormalize($normalized['unit'], new Unit());
